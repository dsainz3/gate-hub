...
MEASUREMENT_DICT = {
    ...
    "ZNMS16LM": [
        ["battery", "rssi"],
        [],
        ["lock", "door", "fingerprint", "armed away"],
    ],
    "ZNMS17LM": [
        ["battery", "rssi"],
        [],
        ["lock", "door", "fingerprint", "antilock", "childlock", "armed away"],
    ],
    "SV40": [
        ["battery", "rssi"],
        [],
    ...
    "MJZNZ018H": [
        ["battery", "rssi"],
        ["button"],
        ["bed occupancy", "snoring", "sleeping"],
    ],
    "MJTZC01YM": [
        ["rssi", "heart rate"],
        ["weight", "impedance", "impedance low", "profile id"],
        [],
    ],
    ...
    "CGP1W": [
        ["temperature", "humidity", "battery", "pressure", "rssi"],
        [],
        [],
    ],
    "CGPR1": [["illuminance", "battery", "rssi"], [], ["light", "motion"]],
    "CGDN1": [
        ["temperature", "humidity", "co2", "pm2.5", "pm10", "rssi"],
        [],
        [],
    ],
    "MHO-C401": [
    ...
    "K9B-2BTN": [
        ["rssi"],
        ["two btn switch left", "two btn switch right"],
        [],
    ],
    "K9B-3BTN": [
        ["rssi"],
    ...
    "YLYK01YL": [
        ["rssi"],
        ["remote"],
        ["remote single press", "remote long press"],
    ],
    ...
    "Mi Scale V1": [
        ["rssi"],
        ["weight", "non-stabilized weight"],
        ["weight removed"],
    ],
    "Mi Scale V2": [
        ["rssi"],
        ["weight", "stabilized weight", "non-stabilized weight", "impedance"],
        ["weight removed"],
    ],
    ...
    "H5055": [
        [
            ...
            "low temperature alarm probe 3",
            "temperature probe 4",
            "temperature alarm probe 4",
            "low temperature alarm probe 4",
            "temperature probe 5",
            "temperature alarm probe 5",
            "low temperature alarm probe 5",
            "temperature probe 6",
            "temperature alarm probe 6",
            "low temperature alarm probe 6",
            "battery",
            "rssi",
        ],
        [],
    ...
    "H5183": [
        ["temperature probe 1", "temperature alarm probe 1", "rssi"],
        [],
        [],
    ],
    "H5184": [
    ...
    "bluSensor Mini": [
        ["temperature", "humidity", "co2", "tvoc", "aqi", "rssi"],
        [],
        [],
    ],
    ...
    "SmartDry cloth dryer": [
        ["temperature", "humidity", "voltage", "battery", "shake", "rssi"],
        [],
        ["switch"],
    ],
