...
@dataclass
class TPLinkRouterSwitchEntityDescription(
    SwitchEntityDescription, TPLinkRouterSwitchEntityDescriptionMixin
):
...
SWITCH_TYPES = (
    TPLinkRouterSwitchEntityDescription(
        ...
        method=lambda coordinator, value: coordinator.set_wifi(
            Connection.GUEST_2G, value
        ),
    ),
    TPLinkRouterSwitchEntityDescription(
        key="wifi_guest_5g",
...
class TPLinkRouterSwitchEntity(
    ...
    def is_on(self) -> bool:
        ...
        return getattr(
            self.coordinator.status, self.entity_description.property
        )
    ...
    def available(self) -> bool:
        ...
        return (
            getattr(self.coordinator.status, self.entity_description.property)
            is not None
        )
