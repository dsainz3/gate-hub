...
obs_sensor_descriptions = [
    ...
    WundergroundPWSSensorEntityDescription(
        ...
        value_fn=lambda data, _: degrees_to_cardinal(
            cast(int, data["observations"][0]["winddir"])
        )
        or "",
    ),
    ...
    WundergroundPWSSensorEntityDescription(
        ...
        unit_fn=lambda metric: (
            UnitOfLength.METERS if metric else UnitOfLength.FEET
        ),
    ...
    WundergroundPWSSensorEntityDescription(
        ...
        unit_fn=lambda metric: (
            ...
            if metric
            else UnitOfVolumetricFlux.INCHES_PER_HOUR
        ),
        value_fn=lambda data, _: cast(float, data),
    ),
    WundergroundPWSSensorEntityDescription(
    ...
    WundergroundPWSSensorEntityDescription(
        ...
        unit_fn=lambda metric: (
            UnitOfPressure.MBAR if metric else UnitOfPressure.INHG
        ),
        value_fn=lambda data, _: cast(float, data),
    ),
    WundergroundPWSSensorEntityDescription(
